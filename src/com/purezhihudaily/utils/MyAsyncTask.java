...
public abstract class MyAsyncTask<Params, Progress, Result> {
	...
	public static final Executor DOWNLOAD_THREAD_POOL_EXECUTOR = new ThreadPoolExecutor(4, 20, KEEP_ALIVE, TimeUnit.SECONDS, sDownloadPoolWorkQueue,
	...
	public enum Status {
		...
		RUNNING,
		/**
		 * Indicates that {@link android.os.AsyncTask#onPostExecute} has
		 * finished.
		 */
		FINISHED,
	}
	 ...
	 * 
	 * @param timeout
	 *            Time to wait after cancelling the operation.
	 * @param unit
	 ...
	 */
	public final MyAsyncTask<Params, Progress, Result> execute(@SuppressWarnings("unchecked") Params... params) {
	 ...
	 *             {@link android.os.AsyncTask.Status#FINISHED}.
	 */
	public final MyAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec, @SuppressWarnings("unchecked") Params... params) {
	...
	private static class AsyncTaskResult<Data> {
		...
		AsyncTaskResult(MyAsyncTask task, @SuppressWarnings("unchecked") Data... data) {
			mTask = task;
			mData = data;
		}
	}
